...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      const friends = []
      this.amigos.forEach( e => friends.push(e.nombre) )
      return friends
    }
    ...
    getHobbies() {
      ...
      // Tu código aca:
      const hobby = []
      this.hobbies.forEach( e => hobby.push(e) )
      console.log(hobby)
      return hobby
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      const ages = []
      this.amigos.forEach( e => ages.push(e.edad) )
      const sum = ages.reduce((age1, age2) => age2 += age1)
